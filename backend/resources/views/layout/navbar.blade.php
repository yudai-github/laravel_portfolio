      ...
      <div class="pr-4 w-60 max-w-full">
        <a href="/" class="w-full flex items-center py-2">
          <img
            ...
            alt="logo"
            class="mr-4 w-[48px] lg:w-[64px] inline-block dark:hidden"
          />
          <img
            src="{{ url('/img/laravel.png') }}"
            alt="logo"
            class="mr-4 w-[48px] lg:w-[64px] hidden dark:inline-block"
          />
          <span class="text-xl font-bold text-[#0c7187] dark:text-white">Yudai_Portfolio</span>
        </a>
      </div>
